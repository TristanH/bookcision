 ...
 */
 ...
 // ****************************************************************
 // BOOKCISION MODIFICATION LOG:
 //
 //  - Export as module (@TODO Get script! webpack loader working instead)
 //
 // ****************************************************************

 // @TODO Make it so that this doesn't write to the global namespace
 // by enclosing it in a .apply({}) call (so that "this" is overriden)
